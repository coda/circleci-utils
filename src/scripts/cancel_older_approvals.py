'''Cancel older builds that are waiting on approval'''
import os
import requests
...
# grab current builds creation time
try:
...
# grab all workflows from this project
...
# cancel all older workflows that are on hold
